...
client.on('interactionCreate', async (interaction) => {
  try {
    ...
    if (cmd === 'help') {
      return interaction.reply({
        embeds: [embedBase('🌸 Summer Baddies Bot — Help',
          ...
          `**Rules**\n/rules\n\n` +
          `**Staff (role higher than bot)**\n/give-weapon, /give-skin, /give-finisher, /player-data, /game-kick, /game-ban, /game-unban, /game-announce, /game-restart, /game-money, /give-tokens, /give-spins, /kick, /ban, /unban, /timeout, /untimeout, /setup-welcome, /setup-leave, /setup-reports, /setup-verified, /setup-levels, /test-welcome, /test-leave, /linked-list, /set-rules, /send-tos`,
    ...
    // ----- STAFF -----
    const staffOnly = ['give-weapon', 'give-skin', 'give-finisher', 'player-data', 'game-kick', 'game-ban', 'game-unban', 'game-announce', 'game-restart', 'game-money', 'give-tokens', 'give-spins', 'kick', 'ban', 'unban', 'timeout', 'untimeout', 'setup-welcome', 'setup-leave', 'setup-reports', 'setup-verified', 'setup-levels', 'test-welcome', 'test-leave', 'linked-list', 'set-rules', 'send-tos'];
    ...
    if (cmd === 'game-kick' || cmd === 'game-ban' || cmd === 'game-unban' || cmd === 'game-announce' || cmd === 'game-restart' || cmd === 'game-money' || cmd === 'give-tokens' || cmd === 'give-spins') {
      let payload = null;
